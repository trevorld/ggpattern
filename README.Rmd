...
Note: there are a lot of dependencies. Please ensure these are installed first
before attempting to install `ggpattern`.  By doing so, this will make any
issues during installation clearer, leading to more meaningful bug reporting.
