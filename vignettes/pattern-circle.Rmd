---
title: "Pattern Circle - Parameters and Examples"
output: 
  rmarkdown::html_vignette:
  toc: true
vignette: >
  %\VignetteIndexEntry{Pattern Circle - Parameters and Examples}
...
| pattern_type             | Pattern type                                  | NA  | `?gridpattern::grid.pattern_circle` |
| pattern_subtype          | Pattern subtype                               | NA  | `?gridpattern::grid.pattern_circle` |
...
* Circles are implemented as an polyclipGrob between a set of circles and the 
