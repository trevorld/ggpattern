...
| pattern_type             | Pattern type                                  | NA        | See [wave](https://trevorldavis.com/R/gridpattern/dev/reference/grid.pattern_wave.html) and [weave](https://trevorldavis.com/R/gridpattern/dev/reference/pattern_weave.html) pattern documentation |
| pattern_subtype          | Pattern subtype                               | NA        | See [weave](https://trevorldavis.com/R/gridpattern/dev/reference/pattern_weave.html) pattern documentation |
