...
filename <- "images/gallery-bar-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
...
```{r echo=FALSE, eval=save_images}
filename <- here::here("vignettes", "images", "gallery-bar2-array.png")
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- here::here("vignettes", "images", "gallery-bar3-array.png")
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
* See `ggpattern::magick_pattern_names` for a list of all image based patterns from `imagemagick`
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-pie-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-bin2d-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-boxplot-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
p <- ggplot(df, aes(trt, outcome)) +
  ...
  labs(
    ...
    subtitle = "pattern = 'placeholder', pattern_type = 'murray'"
  ) + 
  theme(legend.position = 'none') +  
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-col-array.png" 
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-crossbar-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-density-array.png" 
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- here::here("vignettes", "images", "gallery-map-array.png")
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-polygon-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-rect-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
p <- ggplot(huron, aes(year)) +
  ...
  theme_bw(18) +
  labs(
    title = "ggpattern::geom_ribbont_pattern()",
    subtitle = "pattern = 'image'"
  ) 
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-ribbon-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-sf-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-tile-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
...
```{r echo=FALSE, eval=save_images}
filename <- "images/gallery-violin-array.png"
ggsave(filename, plot = p, width = w1, height = h1)
if (opt_png) system(glue("pngquant --speed 4 -f --strip --nofs --skip-if-larger --ext .png  {filename}"))
```
